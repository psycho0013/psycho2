...
const StepCard = ({ number, title, desc, icon, delay }: { number: string, title: string, desc: string, icon: React.ReactNode, delay: number }) => (
    <motion.div
        initial={{ opacity: 0, y: 30 }}
...
const TechCard = ({ title, desc, icon, color, iconColor }: { title: string, desc: string, icon: React.ReactNode, color: string, iconColor: string }) => (
    <motion.div
        whileHover={{ y: -5 }}
...
const PricingCard = ({ title, price, period, features, isPopular, delay }: { title: string, price: string, period?: string, features: string[], isPopular?: boolean, delay: number }) => (
    <motion.div
        initial={{ opacity: 0, y: 30 }}
        whileInView={{ opacity: 1, y: 0 }}
        viewport={{ once: true }}
